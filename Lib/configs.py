...
REDIS_CONSUMER_GROUP = 'AI_BLUE_TEAM_FRAMEWORK_GROUP'
REDIS_CONSUMER_NAME = 'AI_BLUE_TEAM_FRAMEWORK_CONSUMER_0'
...
BASEAUTH_MSG_ZH = {
    ...
    301: '登录失败,密码错误',
    302: '配置错误,Agentic Blue Team不允许使用diypassword作为密码!',
    303: 'Agentic Blue Team被暴力破解,请修改密码后登录',
}
BASEAUTH_MSG_EN = {
    201: 'Login successful',

    301: 'Login failed,password error',
    302: 'Configuration error, Agentic Blue Team does not allow diypassword as a password!',
    303: 'Agentic Blue Team has been brute force attack,please change password',
}
